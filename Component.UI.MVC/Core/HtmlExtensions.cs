...
namespace Component.UI.MVC.Core
{
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString UILabelFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString UILabel(this HtmlHelper helper,
              string text, bool displayHint = true)
        {
            var result = new StringBuilder();
            var hintResource = string.Empty;

            result.Append(helper.Label(text, new { title = hintResource, @class = "control-label" }));
        ...
        public static MvcHtmlString UIEditorFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString UIDropDownList<TModel>(this HtmlHelper<TModel> helper, string name,
        ...
        public static MvcHtmlString UIDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString UITextAreaFor<TModel, TValue>(this HtmlHelper<TModel> helper,
        ...
        public static MvcHtmlString UIAreaDisplayFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-control-static");
            result.InnerHtml = helper.DisplayFor(expression).ToString();

            return MvcHtmlString.Create(result.ToString());
        }

        public static MvcHtmlString UIAreaDisplay(this HtmlHelper helper, string text)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-control-static");
        ...
        public static MvcHtmlString UIDisplayFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression)
        {
            var result = new TagBuilder("div");
        ...
        public static MvcHtmlString UIDisplay<TModel>(this HtmlHelper<TModel> helper, string expression)
        {
            var result = new TagBuilder("div");
            result.Attributes.Add("class", "form-text-row");
